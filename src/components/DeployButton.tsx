...
const ENV_DESC = 'AI provider key, Neon database URLs, NextAuth secret, Google OAuth credentials, payment provider, and Cloudflare R2 storage (see .dev.vars.example)';
