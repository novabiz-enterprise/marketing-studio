 ...
 * 15s 小剧场剧本,再用 OpenRouter HappyHorse 1.1 拿产品图当参考直接出带音的片。
 * 支持多语言(剧本+对白+字幕按所选语言),支持多种喜剧风格。
 *   ① plan   LLM 写双人创意剧本(3秒钩子→冲突→反转,产品有高光时刻)
 *   ② image  gpt-image-2 出产品图(上传则 edit 保产品,否则文生图)
 *   ③ video  alibaba/happyhorse-1.1 参考产品图出 15s 片,generate_audio 自带对白/音效
 *
...
/** OpenRouter HappyHorse 1.1:多张产品图当参考出 15s 双人带货短剧(自带音)。 */
